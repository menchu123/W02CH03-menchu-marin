const questions = [
  ...
  [
    {
      ...
      answer: "antónimo",
      status: 0,
      question: "Palabra que significa lo contrario de una dada",
    },
    {
      letter: "a",
      answer: "área",
      status: 0,
      question:
        "La cantidad de espacio dentro de los límites de una figura plana",
    },
    {
      letter: "a",
      answer: "afluente",
      status: 0,
      question: "Río que desemboca en otro río",
    },
    {
      letter: "a",
      answer: "arcilla",
      status: 0,
      question:
        "Tierra fina, formada por silicato de aluminio, que al humedecerse se hace moldeable y se emplea en cerámica",
    },
  ],
  ...
  [
    {
      ...
      answer: "bisílaba",
      status: 0,
      question: "Palabra que tiene dos sílabas",
    },
    {
      letter: "b",
      answer: "biografía",
      status: 0,
      question: "Narración de la vida de una persona",
    },
    {
      letter: "b",
      answer: "burgueses",
      status: 0,
      question:
        "Así se se llamaban en la Edad Moderna a los habitantes de las ciudades que se habían enriquecido con el comercio",
    },
    {
      letter: "b",
      answer: "babucha",
  ...
  [
    {
      ...
      status: 0,
      question:
        "El tiempo atmosférico que predomina en una zona a lo largo del tiempo",
    },
    {
      letter: "c",
      answer: "compás",
      status: 0,
      question: "Instrumento con dos brazos que dibuja arcos y circunferencias",
    },
    {
      letter: "c",
      answer: "calzada",
      status: 0,
      question:
        "Obra pública realizada por los romanos para mejorar la comunicación y el comercio",
    },
    {
      letter: "c",
      answer: "cúpula",
  ...
  [
    {
      ...
      answer: "devoción",
      status: 0,
      question: "Dedicación con fervor a obras de piedad y religión",
    },
    {
      letter: "d",
      answer: "diástole",
      status: 0,
      question: "Movimiento de relajación del corazón",
    },
    {
      letter: "d",
      answer: "diámetro",
      status: 0,
      question:
        "Línea que une dos puntos de una circunferencia pasando por el centro",
    },
    {
      letter: "d",
      answer: "delineante",
      status: 0,
      question: "Dibujante que traza planos o proyectos ideados por otro",
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      answer: "ebro",
      status: 0,
      question: "Río más largo de España",
    },
    {
      letter: "e",
      answer: "entrecot",
      status: 0,
      question: "Trozo de carne sacado de entre costilla y costilla de la res",
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      status: 0,
      question:
        "Proceso metabólico por el cual las plantas transforman la materia gracias a la energía de la luz",
    },
    {
      letter: "f",
      answer: "farhadi",
      status: 0,
      question:
        "Apellido del cineasta que dirigió la película El Viajante que obtuvo el Oscar a la mejor película de habla no inglesa en 2017",
    },
  ],
  ...
  [
    {
      ...
      answer: "gorgorito",
      status: 0,
      question: "Coloquialmente quiebro que se hace  ganta al cantar",
    },
    {
      letter: "g",
      answer: "gráfico",
      status: 0,
      question: "Representación de datos como líneas o barras",
    },
  ...
  [
    ...
    },
    {
      ...
      answer: "hemorragia",
      status: 0,
      question: "Flujo de sangre por rotura de vasos sanguíneos",
    },
    {
      letter: "h",
      answer: "hombrera",
  ...
  [
    {
      ...
      status: 0,
      question:
        "Percibir íntima o instantáneamente una idea o verdad tal como si la tuviera a la vista",
    },
    {
      letter: "i",
      answer: "inapetencia",
      status: 0,
      question: "Falta de gana de comer",
    },
    {
      letter: "i",
      answer: "isósceles",
      status: 0,
      question: "Triángulo con dos lados iguales",
    },
  ],
  ...
  [
    {
      ...
      answer: "jardinería",
      status: 0,
      question: "Arte y oficio del jardinero",
    },
    {
      letter: "j",
      answer: "jornada",
    ...
    },
    {
      ...
      answer: "júcar",
      status: 0,
      question: "Río que desemboca en la costa valenciana",
    },
  ],
  ...
  [
    {
      ...
      answer: "kilovatio",
      status: 0,
      question: "Medida de potencia de la energía eléctrica.",
    },
    {
      letter: "k",
      answer: "aizkorri",
      status: 0,
      question: "Sierra que destaca en los Montes Vascos",
      contiene: true,
    },
    {
      letter: "k",
  ...
  [
    { letter: "l", answer: "lobera", status: 0, question: "Guarida de lobos" },
    {
      ...
      status: 0,
      question:
        "Apellido del poeta ruso autor de la obra “La muerte del poeta” de 1837",
    },
    {
      letter: "l",
      answer: "litografía",
      status: 0,
      question: "Arte de dibujar o grabar en piedra",
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      answer: "meridianos",
      status: 0,
      question: "Circunferencias imaginarias que pasan por los Polos",
    },
  ],
  ...
  [
    {
      ...
      answer: "nativo",
      status: 0,
      question: "Se aplica al que ha nacido en el lugar de que se trata",
    },
    {
      letter: "n",
      answer: "ninfas",
    ...
    },
    {
      ...
      answer: "neumático",
      status: 0,
      question: "Pieza de caucho que se monta sobre la llanta de una rueda",
    },
  ],
  ...
  [
    {
      ...
      answer: "hogaño",
      status: 0,
      question: "En este año o en esta época, en oposición a antaño",
      contiene: true,
    },
    {
      letter: "ñ",
  ...
  [
    {
      ...
      status: 0,
      question:
        "Capa terrestre que protege a los seres vivos de las radiaciones solares",
    },
    {
      letter: "o",
      answer: "octógono",
      status: 0,
      question: "Polígono de ocho lados",
    },
    {
      letter: "o",
      answer: "omnívoro",
      status: 0,
      question: "Animal que come hierba y carne",
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      answer: "pepa",
      status: 0,
      question: "Apodo con que se conoció a la constitución de 1812",
    },
  ],
  ...
  [
    {
      ...
      answer: "chisquero",
      status: 0,
      question: "Encendedor antiguo de bolsillo",
      contiene: true,
    },
    {
      letter: "q",
      ...
      status: 0,
      question:
        "Órgano respiratorio de los peces formado por láminas o filamentos",
      contiene: true,
    },
    {
      letter: "q",
      answer: "trueque",
      status: 0,
      question: "Intercambio de unos productos por otros sin utilizar monedas",
      contiene: true,
    },
  ],
  ...
  [
    {
      ...
      answer: "ráfaga",
      status: 0,
      question: "Viento fuerte, resentido y de corta duración",
    },
    {
      letter: "r",
      answer: "renard",
      status: 0,
      question:
        "Apellido del ingeniero francés que junto a Arthur C. Krebs, construyó el dirigible militar “La France” en 1884",
    },
    {
      letter: "r",
      answer: "retórica",
  ...
  [
    {
      ...
      answer: "simple",
      status: 0,
      question: "Se aplica a lo que no tiene complicación",
    },
    {
      letter: "s",
      answer: "samba",
    ...
    },
    {
      ...
      answer: "símbolo",
      status: 0,
      question: " Representación gráfica invariable de un concepto.",
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      answer: "terremoto",
      status: 0,
      question: "Seísmo o temblor de tierra",
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      status: 0,
      question:
        "Atribuirse o usar un cargo o título ajenos como si fueran propios",
    },
    {
      letter: "u",
      answer: "utopía",
  ...
  [
    ...
    },
    {
      ...
      answer: "visigodo",
      status: 0,
      question: "Pueblo invasor que derrotó al imperio romano",
    },
  ],
  ...
  [
    {
      ...
      answer: "watson",
      status: 0,
      question: "Descubrió la molécula de ADN",
    },
    {
      letter: "w",
      answer: "waterpolo",
      status: 0,
      question:
        "Deporte que se practica en una piscina, consistente en meter el balón en la portería contraria",
    },
    {
      letter: "w",
      answer: "windsurf",
      status: 0,
      question:
        "Deporte que consiste en navegar de pie sobre una tabla con vela",
    },
  ],
  ...
  [
    {
      ...
      status: 0,
      question:
        "Explicación o interpretación particularmente de los libros de la Biblia",
      contiene: true,
    },
    {
      letter: "x",
      ...
      status: 0,
      question:
        "Ciudad inglesa cuya Universidad compite cada año en una popular regata contra la Universidad de Cambridge",
      contiene: true,
    },
    {
      letter: "x",
      ...
      status: 0,
      question:
        "Pena que consiste en expulsar o hacer salir a una persona de un país o de un territorio",
      contiene: true,
    },
  ],
  ...
  [
    {
      ...
      answer: "moncayo",
      status: 0,
      question: "Nombre de la montaña más alta del sistema ibérico",
      contiene: true,
    },
    {
      letter: "y",
  ...
  [
    {
      ...
      answer: "zodiacal",
      status: 0,
      question: "Perteneciente o relativo al zodíaco",
    },
    {
      letter: "z",
      answer: "zarandeo",
    ...
    },
    {
      ...
      answer: "zoco",
      status: 0,
      question: "Mercadillo tradicional de los árabes",
    },
  ],
];
...
let currentQuestionIndex = roscoActivo
  .map((e) => e.question)
  .indexOf(pregunta.textContent);

const activarLetra = (questionIndex) => {
  const currentLetter = document.getElementById(
    roscoActivo[questionIndex].letter
  );
  currentLetter.classList.add("letra-activa");
};

const desactivarLetra = (questionIndex) => {
  const currentLetter = document.getElementById(
    roscoActivo[questionIndex - 1].letter
  );
...
const desactivarTodasLetras = () => {
  for (let i = 0; i < roscoActivo.length; i++) {
    const letter = document.getElementById(roscoActivo[i].letter);
    letter.classList.remove("letra-activa", "letra-error", "letra-correcta");
  }
};

const errorLetra = (questionIndex) => {
  const currentLetter = document.getElementById(
    roscoActivo[questionIndex].letter
  );
  currentLetter.classList.remove("letra-activa");
...
const correctaLetra = (questionIndex) => {
  const currentLetter = document.getElementById(
    roscoActivo[questionIndex].letter
  );
  currentLetter.classList.remove("letra-activa");
...
const rosco = () => {
  ...
  tituloLetra.textContent =
    (roscoActivo[currentQuestionIndex].contiene
      ? "CONTIENE LA "
      : "EMPIEZA POR ") +
    roscoActivo[currentQuestionIndex].letter.toUpperCase();
...
const responder = () => {
  ...
  if (
    answer === eliminarDiacriticos(roscoActivo[currentQuestionIndex].answer)
  ) {
    aciertos++;
    ...
    popupErrorContenido.textContent = `¡Error! La respuesta correcta es ${roscoActivo[
      currentQuestionIndex
    ].answer.toUpperCase()}.`;
...
const timeOver = () => {
  ...
  contadorAciertos.style.display = "none";
  temporizador.style.display = "none";
  popupFinContenido.textContent = `¡TIEMPO! Has tenido ${aciertos} ${
    aciertos === 1 ? "acierto" : "aciertos"
  } y ${fallos} ${fallos === 1 ? "fallo" : "fallos"}.`;
...
const startGame = () => {
  ...
  pregunta.textContent = roscoActivo[0].question;
  currentQuestionIndex = roscoActivo
    .map((e) => e.question)
    .indexOf(pregunta.textContent);
...
const next = () => {
  if (roscoActivo.every((item) => item.status !== 0)) {
    ...
    contadorAciertos.style.display = "none";
    temporizador.style.display = "none";
    popupFinContenido.textContent = `¡Gracias por jugar! Has tenido ${aciertos} ${
      aciertos === 1 ? "acierto" : "aciertos"
    } y ${fallos} ${fallos === 1 ? "fallo" : "fallos"}.`;
    clearInterval(timerInterval);
...
window.addEventListener("keydown", (event) => {
  ...
  if (event.key === "Enter" && document.activeElement === respuesta) {
    responder();
  }
});
